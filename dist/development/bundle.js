(function () {
	...
	*/
	...
	var View = function (_React$PureComponent) {
	    inherits(View, _React$PureComponent);
	...
	var Page = function (_React$PureComponent) {
	    inherits(Page, _React$PureComponent);
	...
	var NavBar = function (_React$PureComponent) {
	    inherits(NavBar, _React$PureComponent);
	...
	var RenderIf = function (_React$PureComponent) {
	    inherits(RenderIf, _React$PureComponent);

	    function RenderIf() {
	        classCallCheck(this, RenderIf);
	        return possibleConstructorReturn(this, (RenderIf.__proto__ || Object.getPrototypeOf(RenderIf)).apply(this, arguments));
	    }

	    createClass(RenderIf, [{
	        key: 'render',
	        value: function render() {
	...
	var Block = function (_React$PureComponent) {
	    ...
	    createClass(Block, [{
	        ...
	        value: function render() {
	            var props = this.props;
	            var className = props.strong === true ? 'block-strong' : 'block';
	            return react.createElement(
	                'div',
	                { className: className },
	                props.children
	...
	var BlockTitle = function (_React$PureComponent2) {
	    inherits(BlockTitle, _React$PureComponent2);

	    function BlockTitle() {
	        classCallCheck(this, BlockTitle);
	        return possibleConstructorReturn(this, (BlockTitle.__proto__ || Object.getPrototypeOf(BlockTitle)).apply(this, arguments));
	    }

	    createClass(BlockTitle, [{
	        key: 'render',
	        value: function render() {
	            var props = this.props;
	            return react.createElement(
	...
	var BUTTON_STYLES = ['link', 'outline', 'fill'];
	...
	var Buttons = function (_React$PureComponent) {
	    ...
	    createClass(Buttons, [{
	        ...
	        value: function render() {
	            var props = this.props;
	            var className = BUTTON_STYLES.indexOf(props.buttonStyle) === -1 ? null : 'button-' + props.buttonStyle;
	...
	var List = function (_React$PureComponent) {
	    ...
	    createClass(List, [{
	        key: 'render',
	        value: function render() {
	            var className = 'list ' + (this.props.className || '');
	            return react.createElement(
	                'ul',
	                { className: className },
	        ...
	        key: 'getList',
	        value: function getList(items) {
	            var _this2 = this;

	            return items.map(function (item, index, items) {
	                return react.createElement(
	                    'li',
	                    { key: index },
	                    _this2.props.renderer(item, index, items)
	                );
	            });
	        }
	    }]);
	...
	var LinkedList = function (_React$PureComponent) {
	    inherits(LinkedList, _React$PureComponent);

	    function LinkedList(props) {
	        classCallCheck(this, LinkedList);

	        var _this = possibleConstructorReturn(this, (LinkedList.__proto__ || Object.getPrototypeOf(LinkedList)).call(this, props));
	    ...
	    createClass(LinkedList, [{
	        ...
	        key: 'listRender',
	        value: function listRender(item, index, items) {
	            return react.createElement(
	                'button',
	                { type: 'button', 'data-index': index, onClick: this.onItemClick },
	...
	var ModalBackdrop = function (_React$PureComponent) {
	    inherits(ModalBackdrop, _React$PureComponent);

	    function ModalBackdrop() {
	        classCallCheck(this, ModalBackdrop);
	        return possibleConstructorReturn(this, (ModalBackdrop.__proto__ || Object.getPrototypeOf(ModalBackdrop)).apply(this, arguments));
	    }

	    createClass(ModalBackdrop, [{
	        key: 'render',
	        value: function render() {
	            var className = 'modal-backdrop ' + (this.props.className || '');
	...
	var Modal = function (_React$Component) {
	    ...
	    createClass(Modal, [{
	        key: 'render',
	        value: function render() {
	            var className = 'modal ' + (classNames[this.props.align] || '');
	            return react.createElement(
	                Portal,
	                { className: className },
	                react.createElement(ModalBackdrop, { className: 'backdrop-in' }),
	                react.createElement(
	                    'div',
	...
	var ActionsGroup = function (_React$PureComponent) {
	    inherits(ActionsGroup, _React$PureComponent);

	    function ActionsGroup() {
	        classCallCheck(this, ActionsGroup);
	        return possibleConstructorReturn(this, (ActionsGroup.__proto__ || Object.getPrototypeOf(ActionsGroup)).apply(this, arguments));
	    }

	    createClass(ActionsGroup, [{
	        key: 'render',
	        value: function render() {
	            return react.createElement(
	                'div',
	        ...
	        key: 'getButtons',
	        value: function getButtons(actions) {
	...
	var Actions = function (_React$PureComponent) {
	    inherits(Actions, _React$PureComponent);

	    function Actions() {
	        classCallCheck(this, Actions);
	        return possibleConstructorReturn(this, (Actions.__proto__ || Object.getPrototypeOf(Actions)).apply(this, arguments));
	    }
	    ...
	    createClass(Actions, [{
	        ...
	        value: function render() {
	            return react.createElement(
	                Modal,
	                { align: 'bottom' },
	                react.createElement(ActionsGroup, { actions: this.props.actions })
	            );
	        }
	    }]);
	    return Actions;
	...
	var Application = function (_React$Component) {
	    ...
	    createClass(Application, [{
	        key: 'render',
	        value: function render() {
	            var navBar = react.createElement(NavBar, { title: 'Hello world' });
	            ...
	            return react.createElement(
	                ...
	                react.createElement(
	                    Card,
	                    {
	                        header: 'gaearon commented on Mar 6, 2017',
	                        footer: 'gaearon commented on Mar 6, 2017'
	                    },
	                    'React doesn\u2019t really provide ES modules right now, so import React, Component is just an artifact of how Babel works.'
	                ),
	                react.createElement(
	                    Card,
	                    null,
	...
	var ButtonOutlined = function (_React$PureComponent) {
	    inherits(ButtonOutlined, _React$PureComponent);

	    function ButtonOutlined() {
	        classCallCheck(this, ButtonOutlined);
	        return possibleConstructorReturn(this, (ButtonOutlined.__proto__ || Object.getPrototypeOf(ButtonOutlined)).apply(this, arguments));
	    }

	    createClass(ButtonOutlined, [{
	        key: 'render',
	        value: function render() {
	            var props = this.props;
	            return react.createElement(
	...
	var ButtonLink = function (_React$PureComponent) {
	    inherits(ButtonLink, _React$PureComponent);

	    function ButtonLink() {
	        classCallCheck(this, ButtonLink);
	        return possibleConstructorReturn(this, (ButtonLink.__proto__ || Object.getPrototypeOf(ButtonLink)).apply(this, arguments));
	    }
	...
	var ButtonFilled = function (_React$PureComponent) {
	    inherits(ButtonFilled, _React$PureComponent);

	    function ButtonFilled() {
	        classCallCheck(this, ButtonFilled);
	        return possibleConstructorReturn(this, (ButtonFilled.__proto__ || Object.getPrototypeOf(ButtonFilled)).apply(this, arguments));
	    }

	    createClass(ButtonFilled, [{
	        key: 'render',
	        value: function render() {
	            var props = this.props;
	            return react.createElement(
	...
	var Application$1 = function (_React$Component) {
	    inherits(Application, _React$Component);
	    ...
	    createClass(Application, [{
	        key: 'render',
	        value: function render() {
	            var navBar = react.createElement(NavBar, { title: 'Hello world 2' });
	                ...
	                react.createElement(
	                    ...
	                    react.createElement(
	                        ...
	                        react.createElement(
	                            Card,
	                            null,
	                            'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque laoreet nibh sed sem pellentesque, ut tempus ex hendrerit. Donec a leo sodales, laoreet lectus non, tristique arcu. Duis vestibulum vitae diam in tempor. Nullam imperdiet massa sagittis velit egestas semper. Suspendisse risus turpis, blandit vitae massa vel, gravida lacinia tellus. Nunc eu euismod massa, id feugiat nibh. Aliquam ultrices semper dolor non accumsan. Maecenas nec sem pretium, luctus quam quis, tincidunt dui. Nulla dictum id ligula vitae tincidunt.'
	                        )
	                    )
	                )
	            );
	...
	var Application$2 = function (_React$Component) {
	    inherits(Application$$1, _React$Component);

	    function Application$$1(props) {
	        classCallCheck(this, Application$$1);

	        var _this = possibleConstructorReturn(this, (Application$$1.__proto__ || Object.getPrototypeOf(Application$$1)).call(this, props));
	        ...
	        value: function render() {
	            ...
	            return react.createElement(
	                ...
	                this.state.pages.map(function (Page, i) {
	                    return react.createElement(Page, { key: i, wtf: _this2.onWtf.bind(_this2) });
	                })
	            );
	        }
	    }, {
	        key: 'onWtf',
	        value: function onWtf() {
	            this.setState(function (state) {
	                return Object.assign({}, state, {
	                    pages: state.pages.concat([Application$1])
	                });
	            });
	        }
	    }]);
	...
	reactDom.render(react.createElement(Application$2, null), document.getElementById('root'));
