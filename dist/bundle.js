(function () {
	...
	*/
	...
	var RenderIf$1 = react.memo(RenderIf);
	...
	class Card extends react.PureComponent {
	  render() {
	    ...
	    return react.createElement("div", {
	      className: "card"
	    }, react.createElement(RenderIf$1, {
	      condition: props.header
	    }, react.createElement("header", null, props.header)), react.createElement("div", {
	      className: "card-content"
	    }, props.children), react.createElement(RenderIf$1, {
	...
	function filterAttribues(props) {
	  return Object.keys(props).filter(key => /[a-z]/.test(key)).reduce((accum, key) => {
	    accum.key = props[key];
	    return accum;
	  }, {});
	}
	...
	function List(props) {
	  ...
	  return react.createElement("ul", {
	    className: className
	  }, getList(props.renderer)(props.items));
	}

	var List$1 = react.memo(List);

	class LinkedList extends react.PureComponent {
	  constructor(props) {
	    super(props);
	...
	var Portal$1 = react.memo(Portal);
	...
	var ModalBacdrop = react.memo(ModalBackdrop);
	...
	function Modal() {
	  ...
	  return react.createElement(Portal$1, {
	    className: className
	  }, react.createElement(ModalBacdrop, {
	...
	function ActionsGroup(props) {
	  ...
	  }, props.actions.map(getItem));
	}

	ActionsGroup.propTypes = {
	  actions: propTypes.arrayOf(propTypes.object)
	};
	var ActionsGroup$1 = react.memo(ActionsGroup);

	function Actions(props) {
	  return react.createElement(Modal$1, {
	    align: "bottom"
	  }, react.createElement(ActionsGroup$1, {
	...
	function Page1(props) {
	  const navBar = react.createElement(NavBar$1, {
	    title: "Hello world"
	  });
	  return react.createElement(Page$1, {
	    navBar: navBar
	  ...
	  }, "React doesn\u2019t really provide ES modules right now, so import React, Component is just an artifact of how Babel works."), react.createElement(Card, null, react.createElement("p", null, "React doesn\u2019t really provide ES modules right now, so import React, Component is just an artifact of how Babel works."), react.createElement(Button, {
	    onClick: props.wtf
	  }, "Click Me")), react.createElement(Card, {
	    header: "Lorem commented on Mar 6, 2017"
	  }, "React doesn\u2019t really provide ES modules right now, so import React, Component is just an artifact of how Babel works."), react.createElement(BlockTitle, null, "Lorem Ipsum is simply dummy text"), react.createElement(Block, {
	    strong: true
	  }, "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum."), react.createElement(Block, null, "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."));
	}

	var Page1$1 = react.memo(Page1);

	class ButtonOutlined extends react.PureComponent {
	  render() {
	    const props = this.props;
	    return react.createElement(Button, {
	      buttonStyle: "outline",
	...
	class ButtonFilled extends react.PureComponent {
	  render() {
	    const props = this.props;
	    return react.createElement(Button, {
	      buttonStyle: "fill",
